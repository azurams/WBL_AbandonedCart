...
class WBL_AbandonedCart_Block_Adminhtml_Dashboard_Sales extends Mage_Adminhtml_Block_Dashboard_Bar
{
    /**
     *
     */
    ...
    {
        parent::_construct();
        $this->setTemplate('wbl/abandonedcart/dashboard/salebar.phtml');


    }

    /**
     * @return WBL_AbandonedCart_Block_Adminhtml_Dashboard_Sales|Mage_Core_Block_Abstract
     */
...
//        $collection->getSelect()->join('sales_flat_quote' , 'main_table.increment_id = sales_flat_quote.reserved_order_id', 'wbl_abandonedcart_flag');
